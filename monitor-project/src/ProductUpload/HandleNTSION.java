...
//电离层参数文件最终产品
public class HandleNTSION {
	public static void HandleNtsIon(int IntHourFrom,int IntHourTo,long WeeksFrom,long WeeksTo,int DayNumWeekFrom,int DayNumWeekTo) throws IOException
	{
		String speed="NTS";
