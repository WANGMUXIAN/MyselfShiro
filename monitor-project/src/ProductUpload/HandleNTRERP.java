...
//处理快速erp文件,地球自转参数的快速产品
public class HandleNTRERP {
	public static void HandleNtrErp(int IntHourFrom,int IntHourTo,long WeeksFrom,long WeeksTo,int DayNumWeekFrom,int DayNumWeekTo) throws IOException
	{
		String speed="NTR";
