...
//处理对流层参数文件的最终产品
public class HandleNTSTRO {
	public static void HandleNtsTro(int IntHourFrom,int IntHourTo,long WeeksFrom,long WeeksTo,int DayNumWeekFrom,int DayNumWeekTo) throws IOException
	{
		String speed="NTS";
