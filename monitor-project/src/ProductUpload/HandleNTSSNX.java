...
//跟踪站地心坐标文件的最终产品
public class HandleNTSSNX {
	public static void HandleNtsSnx(int IntHourFrom,int IntHourTo,long WeeksFrom,long WeeksTo,int DayNumWeekFrom,int DayNumWeekTo) throws IOException
	{
		String speed="NTS";
		String endString=".snx.Z";
		int i,j;
		long m,n;
		String mS="";
