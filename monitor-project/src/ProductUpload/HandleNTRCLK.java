...
//处理快速clk文件,处理中差文件快速产品
public class HandleNTRCLK {
	public static void HandleNtrClk(int IntHourFrom,int IntHourTo,long WeeksFrom,long WeeksTo,int DayNumWeekFrom,int DayNumWeekTo) throws IOException
	{
		String speed="NTR";
		String endString=".clk.Z";
		int i,j;
		long m,n;
		String mS="";
		...
		//快速产品不考虑延迟，只要负责本天产品即可，当天的24点为分界线，包括当天的24点，就要本天的产品，不超过，就不要
