...
//处理快速ion文件,电离层参数的快速产品
public class HandleNTRION {
	public static void HandleNtrIon(int IntHourFrom,int IntHourTo,long WeeksFrom,long WeeksTo,int DayNumWeekFrom,int DayNumWeekTo) throws IOException
	{
		String speed="NTR";
		String endString=".ion.Z";
		int i,j;
		long m,n;
		String mS="";
