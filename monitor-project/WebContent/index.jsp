					...
					<ul>
						<li><a href="javascript:void(0)" onClick="hiddenDiv(document.getElementById('style215'))"> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp天文件</a>
							<div class="style213" id="style215">
								<ul>
									<li><a href="<%=basePath%>DailydServlet" target="_blank">d（观测文件）</a></li>
									<li><a href="/monitor-project/DailyrServlet" target="_blank">r(BDS广播星历)</a></li>
			...
			<div class="style21">
				...
				<div class="style211" id="3">
					<ul>
						...
						<li><a href="javascript:void(0)" onClick="hiddenDiv(document.getElementById('style0915'))"><h2>产品质量分析</h2></a>
							<div class="style212" id="style0915">				
								<ul>
									<li><a href="ShowChaoKuaiImages.jsp" target="_blank">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp超快产品</a>							
									</li>
									<li><a href="ShowKuaiSuImages.jsp" target="_blank">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp快速产品</a>							
									</li>
									<li><a href="ShowZuiZhongImages.jsp" target="_blank">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp最终产品</a>
									</li>
									<li><a href="" target="_blank">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp查询产品</a>
									</li>
								</ul>
							</div>
						</li>						
