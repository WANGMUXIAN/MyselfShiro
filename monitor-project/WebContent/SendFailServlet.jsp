	...
	<div id="wrapper2">
		...
		<div id="page">
			<div id="content">
				<div class="post">
					<h1 >
						<a ><font color="red">(10.12.5.6-->综合服务中心)上传失败</font> </a>					
					</h1>
					<p class="meta"><span class="posted"><font size="+2">(${weeks }周)</font> </span></p>	
					<div style="clear: both;">&nbsp;</div>
					<div class="entry">
						<c:forEach var="finallylistfail" items="${finallylistfail }">
							${finallylistfail}<br>
						</c:forEach>
				  	</div>
				</div>
				...
				<div class="post">
					<h1 >
						<a ><font color="red">(192.168.7.10-->10.12.5.6)上传失败</font> </a>					
					</h1>
					<div style="clear: both;">&nbsp;</div>
					<div class="entry">
						<c:forEach var="listfail" items="${listfail }">
							${listfail}<br>
						</c:forEach>
				  	</div>
				</div>
			...
			<div id="sidebar">
				<ul>
					<li>
						<div id="search" >
							<form method="post" action="${pageContext.request.contextPath }/SendFailFormServlet">
							  <div>
