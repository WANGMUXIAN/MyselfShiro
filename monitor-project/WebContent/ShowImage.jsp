...
<div id="wrapper">
	<div id="wrapper2">
		...
		<div id="page">
			<div id="content">
				<img  src="${pageContext.request.contextPath }/ShowImageServlet" width="546.4" height="307.2">
 				<img  src="${pageContext.request.contextPath }/ShowImageServlet2" width="546.4" height="307.2">
			</div>
			<!-- end #content -->
			<div id="sidebar">
				<ul>
