...
<title>小时文件：g(GLONASS广播星历)</title>
...
<div id="wrapper">
	<div id="wrapper2">
		<div id="header" class="container">
			<div id="logo">
				<h1><a href="#">功能 <span>菜单</span></a></h1>
			</div>
			<div id="menu">
				<a>GNSS精密分析处理监控系统</a>
			</div>
		...
		<div id="page">
			...
			<div class="post">
				...
				<div class="post">
					<h2 class="title">
						<a >成功站点 </a>
						<a>成功(${hGLONASsuNum }个)</a>
					</h2>
					<div style="clear: both;">&nbsp;</div>
					<div class="entry">
						<c:forEach var="hourlyGLONASsuccess" items="${hourlyGLONASsuccess }" varStatus="status">            
       						${hourlyGLONASsuccess } &nbsp &nbsp  <!-- 每行输出四个站点，每个站点之间空两格 -->
				...
				<div class="post">
					<h2 class="title">
						<a >失败站点 </a>
						<a>失败(${hGLONASfaNum }个)</a>
					</h2>
					<div style="clear: both;">&nbsp;</div>
					<div class="entry">
						<c:forEach var="hourlyGLONASfailed" items="${hourlyGLONASfailed }" varStatus="status">            
       						${hourlyGLONASfailed } &nbsp &nbsp  <!-- 每行输出四个站点，每个站点之间空两格 -->
       						<c:if test="${(status.index+1) % 8 == 0}">
        						<br/>
    						</c:if>        	
						</c:forEach>
			...
			<div id="sidebar">
				<ul>
					<li>
						<div id="search" >
							<form method="post" action="${pageContext.request.contextPath }/HourlygFormServlet">
							  <div>
