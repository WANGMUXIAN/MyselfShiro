		...
		<div id="page">
			<div id="content">
				...
				<div class="post">
					<h2 class="title">
						<a >成功站点 </a>
						<a>成功(${hGPSStationssuNum }个)</a>
					</h2>
					<div style="clear: both;">&nbsp;</div>
					<div class="entry">
						<c:forEach var="hourlyGPSStationssuccess" items="${hourlyGPSStationssuccess }" varStatus="status">            
       						${hourlyGPSStationssuccess } &nbsp &nbsp  <!-- 每行输出四个站点，每个站点之间空两格 -->
				...
				<div class="post">
					<h2 class="title">
						<a >失败站点 </a>
						<a>失败(${hGPSStationsfaNum }个)</a>
					</h2>
					<div style="clear: both;">&nbsp;</div>
					<div class="entry">
						<c:forEach var="hourlyGPSStationsfailed" items="${hourlyGPSStationsfailed }" varStatus="status">            
       						${hourlyGPSStationsfailed } &nbsp &nbsp  <!-- 每行输出四个站点，每个站点之间空两格 -->
       						<c:if test="${(status.index+1) % 8 == 0}">
        						<br/>
    						</c:if>        	
						</c:forEach>
			...
			<div id="sidebar">
				<ul>
					<li>
						<div id="search" >
							<form method="post" action="${pageContext.request.contextPath }/HourlynFormServlet">
							  <div>
