...
<title>小时文件：p(Multi-GNSS广播星历)</title>
	...
	<div id="wrapper2">
		...
		<div id="page">
			<div id="content">
				<div class="post">
					<h2 class="title">
						<a>小时文件：p(Multi-GNSS广播星历)下载情况汇总</a>
					</h2>
				...
				<div class="post">
					<h2 class="title">
						<a >成功站点 </a>
						<a>成功(${hPFileStationssuNum }个)</a>
					</h2>
					<div style="clear: both;">&nbsp;</div>
					<div class="entry">
						<c:forEach var="hourlyPFileStationssuccess" items="${hourlyPFileStationssuccess }" varStatus="status">            
       						${hourlyPFileStationssuccess } &nbsp &nbsp  <!-- 每行输出四个站点，每个站点之间空两格 -->
				...
				<div class="post">
					<h2 class="title">
						<a >失败站点 </a>
						<a>失败(${hPFileStationsfaNum }个)</a>
					</h2>
					<div style="clear: both;">&nbsp;</div>
					<div class="entry">
						<c:forEach var="hourlyPFileStationsfailed" items="${hourlyPFileStationsfailed }" varStatus="status">            
       						${hourlyPFileStationsfailed } &nbsp &nbsp  <!-- 每行输出四个站点，每个站点之间空两格 -->
       						<c:if test="${(status.index+1) % 8 == 0}">
        						<br/>
    						</c:if>        	
						</c:forEach>
			...
			<div id="sidebar">
				<ul>
					<li>
						<div id="search" >
							<form method="post" action="${pageContext.request.contextPath }/HourlypFormServlet">
							  <div>
