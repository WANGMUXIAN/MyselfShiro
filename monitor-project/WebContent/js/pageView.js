...
/** 构建一个StringBuffer类-----结束 */
/*********************************************************查询分页************************************************************/
//function initPageSearch(currentpage, totalpage){
//	if(totalpage == 0) return;
//	var sbf = new StringBuffer();
//	if(currentpage == 1){
//		sbf.append("<a href=\"javascript:void(0);\" id=\"startpage\">首页</a>");
//		sbf.append("<a href=\"javascript:void(0);\" id=\"lastpage\">上一页</a>");
//	}else{
//		sbf.append("<a href=\"javascript:topageSearch(1);\" id=\"startpage\">首页</a>");
//		sbf.append("<a href=\"javascript:topageSearch(");
//		sbf.append(currentpage-1);
//		sbf.append(");\" id=\"lastpage\">上一页</a>");
//	}
//	/** 遍历页数---开始 */
//	if(totalpage < 11){
//		for(var i=1; i<=totalpage; i++){
//			i == currentpage ? sbf.append(current_YSearch(i)) : sbf.append(current_NSearch(i));
//		}
//	}else if(totalpage - currentpage < 5){
//		for(var i=currentpage-4; i<=totalpage; i++){
//			i == currentpage ? sbf.append(current_YSearch(i)) : sbf.append(current_NSearch(i));
...
//		sbf.append(");\" id=\"endpage\">末页</a>");
//	}
//	$(".mainlist_pageSearch").html(sbf.toString());
//}
//function current_YSearch(index){
//	var str = "<a href=\"javascript:void(0);\" class=\"page_current\">" + index + "</a>";
//	return str;
//}
//
...
// * @returns {String}
// */
//function current_NSearch(index){
//	var str = "<a href=\"javascript:topageSearch(" + index + ");\">" + index + "</a>";
//	return str;
//}